...
class Particle {
    ...
    animate() {
        ...
        if (this.currentDuration <= 200) {
            ...
            this.colour = this.getColour(240, 240, 240, 5);
            ...
            this.colour = this.getColour(this.red, this.green, this.blue, 5 + (Math.random() * 0.3));
    ...
    render() {
        ...
        ctx.shadowBlur = 8;
        ctx.shadowColor = this.getColour(this.red + 150, this.green + 150, this.blue + 150, 5);
        ctx.fill();
